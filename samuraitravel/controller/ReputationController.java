...
public class ReputationController {
    ...
    public String create(@ModelAttribute @Validated ReputationForm reputationForm ,  @AuthenticationPrincipal UserDetailsImpl userDetailsImpl, BindingResult bindingResult, RedirectAttributes redirectAttributes, Model model) {
    	  if (bindingResult.hasErrors()) {
              return "reviews/index";
          }
    	  User user = userDetailsImpl.getUser(); 
    	  Integer score = Integer.parseInt(reputationForm.getScore().toString());
    	  reputationForm.setUserId(user.getId());
    	  reputationForm.setScore(score);
