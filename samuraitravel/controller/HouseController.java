...
public class HouseController {
    ...
    public HouseController(HouseRepository houseRepository,ReputationRepository reputationRepository, ReputationService reputationService) {
    ...
    public String create(@ModelAttribute @Validated ReputationForm reputationForm, BindingResult bindingResult, RedirectAttributes redirectAttributes) {
